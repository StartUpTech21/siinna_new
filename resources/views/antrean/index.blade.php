...
<div class="flex">
    <div class="">
      ...
      <input type="submit"  value="" onClick="document.location.reload(true)">
        ...
        {{-- <h1>Nomor TELLER terakhir{{$end_nomor_antrean_teller->kode_antrean}}{{$end_nomor_antrean_teller->end_nomor_antrean}}</h1> --}}
    ...
    <div class="">
      @if(Request()->user()->level1 == 'teller')
      <form action="{{asset('antrean',$nomor_antrean_teller_sekarang->id)}}" method="post">
        @csrf
        @method("PUT")
      ...
      @elseif(Request()->user()->level1 == 'cs')
      <form action="{{asset('ean',$nomor_antrean_cs_sekarang->id)}}" method="post">
        @csrf
        @method("PUT")
